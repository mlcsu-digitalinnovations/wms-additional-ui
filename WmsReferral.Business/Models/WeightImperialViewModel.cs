...
namespace WmsReferral.Business.Models
{
    public class WeightImperialViewModel
    {
        ...
        [Range(5, 50, ErrorMessage = "<span class=\"nhsuk-u-visually-hidden\">error: </span>The field Stones must be a number between 5 and 50")]
        ...
        [Range(1900, 2100, ErrorMessage = "<span class=\"nhsuk-u-visually-hidden\">error: </span>The field Year, must be a valid number/year")]
