...
namespace WmsStaffReferral.Controllers
{
    public class StaffReferralController : SessionControllerBase
    {
        ...
        private const string APIENDPOINT = "SelfReferral";
            ...
            try
            {
                ...
                if (result.StatusCode == HttpStatusCode.OK)
                {
                    ...
                    referral.ProviderChoices.Add(new Provider()
                    {
                        ...
                        Summary = "If you need more time to choose a service, select this option and we'll send you a text message within 2 working days. This message, from ‘NHS DWMP’, will contain a link to a website from which you can access the list of available programmes. Please note that the link will expire in 48 hours."
