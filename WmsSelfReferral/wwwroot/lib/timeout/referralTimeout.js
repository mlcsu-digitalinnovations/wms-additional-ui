; (function ($, window) {
    ...
    $.fn.referralTimeout = function (opts) {
        ...
        var uiDialog = function () {
            ...
            var $dialogueDiv = '<div id="notifyLogout"><p>For your security your session will end in <span id="sessioncountdown">' + $countDownTimer + '</span> due to inactivity. <br /><br />Select End Session to end it now, otherwise select Continue to stay logged in.</p></div>';
