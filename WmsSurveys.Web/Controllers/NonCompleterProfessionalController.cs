...
{
    public class NonCompleterProfessionalController : SessionControllerBase
    {        
        private readonly ILogger<NonCompleterProfessionalController> _logger;
        private readonly TelemetryClient _telemetry;
        private readonly IQuestionnaireData _sessionData;
        private readonly string _questionnaireType = "ncp";
        public NonCompleterProfessionalController(ILogger<NonCompleterProfessionalController> logger,
