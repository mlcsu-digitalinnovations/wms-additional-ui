...
{
    public class CompleterProfessionalLevel2And3Controller : SessionControllerBase
    {        
        private readonly ILogger<CompleterProfessionalLevel2And3Controller> _logger;
        private readonly TelemetryClient _telemetry;
        private readonly IQuestionnaireData _sessionData;
        private readonly string _questionnaireType = "cpl23";
