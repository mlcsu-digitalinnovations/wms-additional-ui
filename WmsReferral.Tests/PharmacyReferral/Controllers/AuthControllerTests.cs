...
namespace WmsReferral.Tests.PharmacyReferral.Controllers
{
    public class AuthControllerTests
    {
        ...
        public async Task RequestNewToken_ReturnsRedirectValidateCode() 
        {
            ...
            //mock api
            _wmsReferralServiceMock.Setup(x => x.GeneratePharmacyTokenAsync(It.IsAny<string>(), It.IsAny<int>()))
        ...
        public async Task ValidateCodePost_ReturnValid()
        {
            ...
            //mock api
            _wmsReferralServiceMock.Setup(x => x.ValidatePharmacyTokenAsync(It.IsAny<string>(), It.IsAny<string>()))
