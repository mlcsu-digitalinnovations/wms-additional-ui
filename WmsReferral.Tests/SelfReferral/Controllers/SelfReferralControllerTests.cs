...
namespace WmsReferral.Tests.SelfReferralTests.Controllers
{
    public class SelfReferralControllerTests
    {
        ...
        public async Task AddressPost_ReturnsModelError_PostCodeNotFound()
        {
            ...
            SelfReferral referral = new() { Email = "test@test.com", ConsentForGpAndNhsNumberLookup = true };
        ...
        public async Task CheckAnswersPost_ReturnsOkAction()
        {
            ...
            //setup session/context
            _classUnderTest.ControllerContext.HttpContext = TestSetup.InitializeControllerContext(referral, keyAnswer, providerChoices, "SelfReferral").Object;
        ...
        public void ProviderChoiceGet_ReturnsView()
        {
            ...
            //setup session/context
            _classUnderTest.ControllerContext.HttpContext = TestSetup.InitializeControllerContext(new WmsReferral.Business.Models.StaffReferral(), new KeyAnswer(), providerChoices, "SelfReferral").Object;
